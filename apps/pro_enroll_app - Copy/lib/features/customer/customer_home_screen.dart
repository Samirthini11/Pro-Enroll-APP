        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text('Nearby Professionals', style: Theme.of(context).textTheme.titleLarge),
                  const Spacer(),
                  TextButton(
              ...
              if (state.loading)
                ...
                const Padding(
                  ...
                  child: EmptyState(
                    ...
                    title: 'No pros nearby',
                    body: 'Try changing your location above.',
                  ),
                )
              else
                  ...
                  return Padding(
                    ...
                    child: _NearbyProCard(
                      ...
                      onTap: () => context.push(
                        ...
                        extra: {'pro_id': pro.id, 'category_code': pro.categoryCode},
                      ),
                    ),
                  );
                }),
                        ...
                        if (pro.distanceKm != null)
                          Row(
                            ...
                            children: [
                              ...
                              Text('${pro.distanceKm!.toStringAsFixed(1)} km',
                      ...
                      return Card(
                        child: ListTile(
                          ...
                          leading: Container(
                            ...
                            child: Icon(cat?.icon ?? Icons.build, color: AppTheme.brandPrimary, size: 20),
                          ),
                          title: Text(b.professionalName,
                              style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis),
                          subtitle: Text(cat?.nameEn ?? b.categoryCode, style: const TextStyle(fontSize: 12)),
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 28,
                        backgroundColor: AppTheme.brandPrimaryLight,
                        child: const Icon(Icons.person, size: 28, color: AppTheme.brandPrimary),
                      ),
