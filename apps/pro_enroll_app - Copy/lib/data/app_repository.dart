...
class AppRepository implements ProRepository {
  ...
  Future<Map<String, dynamic>> fetchProDetail(int proId, {String? categoryCode}) =>
      _whenApi(
        api: () => _api.fetchProDetail(proId, categoryCode: categoryCode),
        mock: () => _mock.fetchProDetail(proId, categoryCode: categoryCode),
      );
  ...
  @override
  Future<void> updateCustomerProfile({required String fullName}) => _whenAuthedApi(
        api: () => _api.updateCustomerProfile(fullName: fullName),
        mock: () => _mock.updateCustomerProfile(fullName: fullName),
      );
}
