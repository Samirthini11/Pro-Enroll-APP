...
class ApiRepository implements ProRepository {
  ...
  Future<EarningsSummary> fetchEarnings() async {
    ...
    if (summary is Map<String, dynamic>) return earningsFromApi(summary);
  ...
  @override
  Future<Map<String, dynamic>> fetchProDetail(int proId, {String? categoryCode}) async {
    final q = <String, String>{};
    if (categoryCode != null) q['category_code'] = categoryCode;
    final data = await _client.get('/v1/customer/pros/$proId', auth: false, query: q.isNotEmpty ? q : null);
