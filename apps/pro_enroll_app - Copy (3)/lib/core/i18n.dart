...
const _strings = <String, Map<String, String>>{
  ...
  'onboarding.fee.helper': {
    'en':
        'Based on the services you selected. Customers pay this fixed charge when you visit, before any repair work.',
    'ta':
        'நீங்கள் தேர்ந்தெடுத்த சேவைகளின் அடிப்படையில். உங்கள் வருகை நேரத்தில், பழுதுபார்ப்பு தொடங்குவதற்கு முன் வாடிக்கையாளர் இந்த நிலையான கட்டணத்தை செலுத்துவார்.',
  },
